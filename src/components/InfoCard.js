          ...
          <ModalBody pb={6}>
            <form onSubmit={handleUpdateMe}>
              ...
              <input
                ...
                value="Update"
                onClick={onClose}
                className="border text-center mt-5 cursor-pointer border-[#5f43cf] bg-[#5f43cf] w-full h-[50px] rounded-[5px] text-white font-semibold hover:border-[#5f43cf] hover:bg-transparent hover:text-[#5f43cf] hover:duration-1650"
              />
            </form>
          </ModalBody>
        </ModalContent>
