  ...
  return (
    <div className="post-area mx-auto py-12">
      <h2 className="font-bold text-center py-5 mb-6 text-4xl">
        Add a <span className="text-[#5f43cf]">Post</span>
      </h2>
      <div>
        <form onSubmit={handleSubmit(handleAddProduct)}>
          <Card className="mx-auto" maxW="lg">
            <CardHeader>
              <Flex spacing="4">
                <Flex flex="1" gap="4" alignItems="center" flexWrap="wrap">
                  <Avatar
                    name="Segun Adebayo"
                    src="https://headshots-inc.com/wp-content/uploads/2020/12/Blog-Images.jpg"
                  />

                  <Box>
                    <Heading size="sm">Jhon Abraham</Heading>
                    <Text>
                      {time} {date}
                    </Text>
                  </Box>
            ...
            >
              ...
              {user?.uid ? (
                <Button
                  style={{ background: "#5f43cf", color: "white" }}
                  type="submit"
                  as={Button}
                  colorScheme="pink"
                  flex="1"
